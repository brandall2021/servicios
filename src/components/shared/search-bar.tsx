    ...
    <form onSubmit={handleSearch} className="w-full max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row gap-2 bg-white rounded-xl shadow-lg border border-zinc-200 p-2">
        ...
        <select
          ...
          className="h-10 px-3 border border-zinc-200 rounded-lg text-sm bg-white text-zinc-600 outline-none focus:border-orange-500"
        >
        ...
        <button
          type="submit"
          className="h-10 px-6 bg-orange-600 text-white rounded-lg text-sm font-medium hover:bg-orange-700 transition-colors"
        >
          Buscar
        </button>
      </div>
